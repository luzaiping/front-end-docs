...
4. JavaScript中的变量在内存中的具体存储形式
  > 答：基本类型直接存储在 stack 中；引用类型的指针存储在 stakc，对应的值存储在 Heap 中。
...
10. 出现小数精度丢失的原因，JavaScript可以存储的最大数字、最大安全数字，JavaScript处理大数字的方法、避免精度丢失的方法
  > 这是经典的 0.1 + 0.2 === 0.30000000000000004 问题, [原因参考这篇文章](https://juejin.im/post/5b20cbb051882513ac20354f)。这个问题的[答案参考这篇文章](https://zhuanlan.zhihu.com/p/104948790)
